...
export const AboutPage = () => {
  return (
    <>
      <p className="text-[40px] md:text-[50px] font-medium shimmer">-C-</p>
      <div className="w-[140px] md:w-[200px] h-[1px] bg-black mt-4 md:mt-6"></div>
      <p className="text-[16px] md:text-[20px] mt-6 w-full md:w-[600px] leading-16">
        ...
        <span className="text-gray-500 font-light">
          ...
          seamless user experiences. Over the past few years I've specifialized
          in developing first class experiences for enterprise companies and
          start ups.
        </span>
        <br></br>
