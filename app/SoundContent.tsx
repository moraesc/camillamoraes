...
export default function SoundContent({
  ...
  return (
    <div className="margin-auto justify-center flex flex-col w-full rounded-lg rounded-lg px-4 py-4 shadow-lg mb-8">
      <div className="overflow-scroll">
        ...
        <p className="text-[14px] text-gray-600">
          In February 2022, I joined Sound.xyz as the company's 6th employee and
          4th Software Engineer. I contributed to the company scaling to 20
          employees within a year and a half and worked on multiple projects
          throughout my course there. I worked on multiple projects. Here are
          some highlights:
        </p>
        ...
        <p className="text-[14px] text-gray-600 mb-4">
          ...
          website's search experience and create a seamless way to discover new
          artists and music.
        </p>
        ...
        <p className="text-[14px] text-gray-600 mb-4">
          ...
          "Golden Egg" NFT. Artists were able to upload unique cover art for
          their Golden Egg NFT. To showcase the both the regular cover art and
          Golden Egg cover art in a creative way, I implemented an animation
